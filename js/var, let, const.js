...
const z = 2; // you can't change consts.

/* Now, a different scope... */
if(true) {
  console.log(x); // returns 4
  console.log(y); // returns undefined, as variables made with let are only available in that scope
  console.log(z) // returns 3
  
  let n = 23; // how about we declare this variable with let...
}
console.log(n) // this returns undefined, because n isn't in the same scope!
